...
const FeedbackForm = () => {
    ...
    return (
        <form action="">
            <div>
                <h3 className='text-[#181A1E] text-[16px] leading-6 font-semibold mb-4 mt-0'>
                    ...
                    {[...Array(5)].map((_, index) => {
                        ...
                        return (
                            <button key={index} type='button'
                                className={`${index <= ((rating && hover) || hover) ? 'text-[#FFB800]' : 'text-gray-400'} 
            ...
            <div className='mt-[30px]'>
                ...
                <textarea 
                className='border border-solid border-[#0066ff34] focus:outline outline-[#0066ff] w-1/2 px-4 py-3 rounded-md '
                rows='5'
